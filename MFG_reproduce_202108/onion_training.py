...
if training_mode in [0, 1]:
    ...
    if training_mode == 0:
        ...
        old_model_name = '02923e5_0_123_init_randomly_EGPHS_EPHS_EHS_EH_E.hdf5' # best of all
        GPU_device = "0"
        ...
        old_model_name = '02923e5_1_123_init_randomly_EGPHS_EPHS_EHS_EH_E.hdf5' # best of all
        GPU_device = "1"
    else:
        pass
